...
use std::str::FromStr;
use yield_optimizer::basset_farmer_config_holder::{
...
pub fn instantiate(
    ...
    let config = Config {
        ...
        basset_farmer_strategy_contract: deps
            .api
            .addr_validate(&msg.basset_farmer_strategy_contract_addr)?,
...
fn update_config(
    ...
    if let Some(ref basset_farmer_strategy_contract_addr) = basset_farmer_strategy_contract_addr {
        current_config.basset_farmer_strategy_contract = deps
            .api
            .addr_validate(basset_farmer_strategy_contract_addr)?;
    }
...
pub fn query_config(deps: Deps) -> StdResult<ConfigResponse> {
    ...
    Ok(ConfigResponse {
        ...
        basset_farmer_strategy_contract_addr: config.basset_farmer_strategy_contract.to_string(),
