...
use yield_optimizer::basset_farmer_config_holder::{ExecuteMsg, GovernanceMsg};
...
fn fail_to_change_config_if_sender_is_not_governance() {
    ...
    let msg = yield_optimizer::basset_farmer_config_holder::InstantiateMsg {
        ...
        basset_farmer_strategy_contract_addr: BASSET_FARMER_CONFIG_CONTRACT.to_string(),
    ...
    let change_config_msg = ExecuteMsg::Governance {
        governance_msg: GovernanceMsg::UpdateConfig {
            ...
            basset_farmer_strategy_contract_addr: None,
...
fn success_to_change_config_if_sender_governance() {
    ...
    let new_basset_farmer_strategy_contract_addr = "addr7006".to_string();
